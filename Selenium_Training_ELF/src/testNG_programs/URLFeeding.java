...
public class URLFeeding {
	...
	public String[] passTestData() throws EncryptedDocumentException, IOException{
		...
		int cellCount = book.getSheet("Sheet1").getRow(1).getPhysicalNumberOfCells()-1;
		String[] data = new String[cellCount];
		for(int i=0;i<cellCount;i++) {
			data[i] = book.getSheet("Sheet1").getRow(1).getCell(i+1).toString();
		}
		return data;
	}
